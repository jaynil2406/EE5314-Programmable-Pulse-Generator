...
uint32_t phi2,phi1;
uint8_t mode=100;
float offset1,amp1,amp2,offset2;
...
// ***********************************STEP 7 (DC COMMAND )***********************************************************
      ...
      if(is_command("sine",4))
      {
          ...
          uint16_t i;
           amp1 = getArgInt(getString(2));
           offset1 = getArgFloat(getString(3));
                         float freq1 = getArgFloat(getString(1));
          ...
          {
              uint16_t i;
              amp2 = getArgInt(getString(2));
              offset2 = getArgFloat(getString(3));
              float freq2 = getArgFloat(getString(1));
      ...
      if(is_command("cycles",2))
      {

          cycles = getArgInt(getString(1));
         // check  = 100000/freq1;
      }
           argCount =0;
